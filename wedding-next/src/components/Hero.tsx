...
export default function Hero() {
    ...
    const handleParallax = () => {
      ...
      if (contentRef.current) {
        ...
        if (scrolled < heroHeight) {
          ...
          contentRef.current.style.transform = `translateY(${translateY}px) scale(${Math.max(0.95, scale)})`;
        }
      }
    };
  ...
  return (
    ...
    >
      ...
      <div
        ref={contentRef}
        className="relative z-[2] text-center text-white px-6 max-w-[800px] animate-fade-up"
